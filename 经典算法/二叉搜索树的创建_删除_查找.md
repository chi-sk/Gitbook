...
- 它的左右子树也分别为二叉搜索树。
<div align="center"> <img src="pngs/20180902083207396.jpg"/> </div>
## 二叉搜索树的操作
**查找关键字data**:
①.若根节点为空，即二叉搜索树为空。返回0。
...
```
**插入元素data**:在二叉树中插入元素时，必须检测该元素在树中是否已经存在，若存在则不进行插入。
①.树为空，即二叉树为空时直接插入。
...
原文链接：https://blog.csdn.net/zhao_miao/article/details/82312723